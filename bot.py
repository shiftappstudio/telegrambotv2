...
async def generate_and_send_photo_from_photo(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    print(update.effective_user)
    print(update.user) 
    await context.bot.send_phooto(update.effective_message.chat.username, image_to_bytes(im), caption=f'"{update.message.caption}" - Generated by @{update.effective_user.username} | @MyAnimeAI | myanime.ai', reply_markup=get_try_again_markup(), reply_to_message_id=update.message.message_id)
